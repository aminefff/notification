...
const QUOTES = [
  "من لم يذق 1مرّ التعلم ساعة، تجرّع ذلّ الجهل طول حياته",
  "طلب 1العلم أفضل من صلاة النافلة",
  "هَلْ يَسْتَوِي الَّذِينَ1 يَعْلَمُونَ وَالَّذِينَ لا يَعْلَمُونَ",
  "العلم في 1الصغر كالنقش على الحجر",
  ...
  return (
    <div className="p-4 sm:p-6 pb-24 space-y-8 max-w-4xl mx-auto flex flex-col items-center">
      ...
      <section className="w-full optimize-scrolling" style={{ contentVisibility: 'auto' }}>
        <div className="w-full bg-neutral-900/40 backdrop-blur-md border border-white/10 rounded-[2.5rem] p-8 text-center relative overflow-hidden shadow-2xl">
      ...
      <section className="w-full text-center optimize-scrolling" style={{ contentVisibility: 'auto' }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div onClick={() => { setActiveTool('parser'); playClickSound(); }} className="group relative overflow-hidden rounded-[2rem] p-6 shadow-xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-blue-500/50 transition-all flex flex-col items-center justify-center cursor-pointer h-40 active:scale-95 text-center">
            ...
            <div onClick={() => { setActiveTool('rhetoric'); playClickSound(); }} className="group relative overflow-hidden rounded-[2rem] p-6 shadow-xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-emerald-500/50 transition-all flex flex-col items-center justify-center cursor-pointer h-40 active:scale-95 text-center">
            ...
            <div onClick={() => { setActiveTool('corrector'); playClickSound(); }} className="group relative overflow-hidden rounded-[2rem] p-6 shadow-xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-brand/50 transition-all flex flex-col items-center justify-center cursor-pointer h-40 active:scale-95 text-center">
            ...
            <div onClick={() => { setActiveTool('builder'); playClickSound(); }} className="group relative overflow-hidden rounded-[2rem] p-6 shadow-xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-purple-500/50 transition-all flex flex-col items-center justify-center cursor-pointer h-40 active:scale-95 text-center">
