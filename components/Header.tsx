...
import { Settings, LogOut, Bell, Shield, ChevronDown, Timer, Calculator, Users, Coins, HelpCircle, BookOpen } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ user, appLogo, hasUnreadNotifs, unrepliedMessagesCount = 0, onOpenNotifications, onOpenSettings, onLogout, onNavigate }) => {
    ...
    return (
        <header className="fixed top-0 w-full bg-black/40 backdrop-blur-xl z-40 border-b border-white/5 px-4 h-16 flex justify-between items-center">
