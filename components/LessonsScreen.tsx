...
import { playClickSound, playLifelineSound } from '../utils/audio';
...
const GLASS_CARD = "bg-neutral-900/50 backdrop-blur-2xl border border-white/5 shadow-2xl hover:border-brand/30 active:scale-[0.97] transition-all duration-300 cursor-pointer overflow-hidden relative group clickable";
