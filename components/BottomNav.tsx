...
const BottomNav: React.FC<BottomNavProps> = ({ currentTab, onTabChange }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50">
        <div className="bg-black/80 backdrop-blur-xl border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] h-16 sm:h-20 flex justify-around items-center px-1 pb-safe">
            {tabs.map((tab) => {
